...
public class TruckRepositoryTest {
    ...
    public void findAllByTruckSizeAndStatus() {
        Truck truck1 = new Truck(Vin.of("test-0001"), TruckStatus.IN_INSPECTION,1000, TruckSize.LARGE, null);
//        truck1.sendForInspection();
        Truck truck2 = new Truck(Vin.of("test-0002"), TruckStatus.RENTED,2000, TruckSize.LARGE, null);
//        truck2.sendForInspection();
        Truck truck3 = new Truck(Vin.of("test-0003"), TruckStatus.RENTABLE,3000, TruckSize.LARGE, null);
        Truck truck4 = new Truck(Vin.of("test-0004"), TruckStatus.RENTABLE,3000, TruckSize.SMALL, null);
    ...
    public void findAllByTruckSizeAndStatus_noneFound() {
        Truck truck1 = new Truck(Vin.of("test-0001"),
